  ...
  return (
    <AdminPanelLayout title="Print Orders">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Print Orders</h1>
        <Button asChild>
      ...
      <Suspense fallback={<div className="flex h-40 items-center justify-center">Loading print orders...</div>}>
        <PrintOrdersTable initialPrintOrders={success ? printOrders : []} error={error} />
      </Suspense>
    </AdminPanelLayout>
  );
}
