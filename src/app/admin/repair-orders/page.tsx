  ...
  return (
    <AdminPanelLayout title="Repair Orders">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Repair Orders</h1>
        <Button asChild>
      ...
      <Suspense fallback={<div className="flex h-40 items-center justify-center">Loading repair orders...</div>}>
        <RepairOrdersTable initialRepairOrders={success ? repairOrders : []} error={error} />
      </Suspense>
    </AdminPanelLayout>
  );
}
