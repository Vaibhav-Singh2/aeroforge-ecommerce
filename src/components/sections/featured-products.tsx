...
const mockProducts = {
  featured: [
    {
      ...
      price: 599.99,
      comparePrice: 699.99,
      image: "https://images.pexels.com/photos/10944048/pexels-photo-10944048.jpeg?auto=compress&cs=tinysrgb&w=800",
      category: "Drones",
      rating: 4.8,
      reviewCount: 124,
      isBestseller: true,
    ...
    },
    {
      ...
      price: 799.99,
      comparePrice: null,
      image: "https://images.pexels.com/photos/9784773/pexels-photo-9784773.jpeg?auto=compress&cs=tinysrgb&w=800",
      category: "Drones",
      rating: 4.7,
      reviewCount: 89,
      isBestseller: false,
    ...
    },
    {
      ...
      price: 349.99,
      comparePrice: 399.99,
      image: "https://images.pexels.com/photos/53904/pexels-photo-53904.jpeg?auto=compress&cs=tinysrgb&w=800",
      category: "Planes",
      rating: 4.5,
      reviewCount: 56,
      isBestseller: false,
    ...
    },
    {
      ...
      price: 129.99,
      comparePrice: null,
      image: "https://images.pexels.com/photos/4611435/pexels-photo-4611435.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  new: [
    ...
    },
    {
      ...
      price: 189.99,
      comparePrice: 219.99,
      image: "https://images.pexels.com/photos/5417837/pexels-photo-5417837.jpeg?auto=compress&cs=tinysrgb&w=800",
      category: "Accessories",
      rating: 4.5,
      reviewCount: 32,
      isBestseller: false,
    ...
    },
    {
      ...
      price: 459.99,
      comparePrice: null,
      image: "https://images.pexels.com/photos/7262397/pexels-photo-7262397.jpeg?auto=compress&cs=tinysrgb&w=800",
      category: "Drones",
      rating: 4.3,
      reviewCount: 17,
      isBestseller: false,
    ...
    },
    {
      ...
      price: 39.99,
      comparePrice: 49.99,
      image: "https://images.pexels.com/photos/8885071/pexels-photo-8885071.jpeg?auto=compress&cs=tinysrgb&w=800",
      category: "Parts",
      rating: 4.6,
      reviewCount: 41,
      isBestseller: false,
  ...
  return (
    <section className="container py-8">
      <div className="flex flex-col md:flex-row justify-between items-center mb-8">
        ...
        <Tabs defaultValue="featured" className="w-full md:w-auto" onValueChange={setTabValue}>
      ...
      <div className="flex justify-center mt-12">
        <Button asChild>
          <Link href={`/category/${tabValue === "featured" ? "all" : tabValue}`} className="flex items-center gap-1">
    ...
    <Card className="overflow-hidden group">
      ...
      <CardContent className="pt-6">
        ...
        <div className="flex items-center gap-1 mt-1">
          <div className="flex">
            {[...Array(5)].map((_, i) => (
              <Star key={i} className={`h-3.5 w-3.5 ${i < Math.floor(product.rating) ? "fill-amber-400 text-amber-400" : "text-muted-foreground fill-muted"}`} />
            ))}
          </div>
